...
function [Glob ,Loc ,angle, nframes,skl]=testshow(jnt,tab)
...
for j = 1 :num_frame             %%%%%%%% same as number of frames  and number of transformation.
