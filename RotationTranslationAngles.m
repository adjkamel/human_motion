...
for i = 1 : nframes
 ...
 view(3);
  ...
  annotation('textbox', [0, 0.9, 0, 0.1], 'string', 'joint','FontSize',7); 
   annotation('textbox', [0.02, 0.9, 0, 0.1], 'string', 'X-GRot','FontSize',7); 
    annotation('textbox', [0.06, 0.9, 0, 0.1], 'string','Y-GRot','FontSize',7); 
     annotation('textbox', [0.10, 0.9, 0, 0.1], 'string', 'Z-GRot','FontSize',7); 
      annotation('textbox', [0.14, 0.9, 0, 0.1], 'string', 'X-GTrans','FontSize',7); 
       annotation('textbox', [0.18, 0.9, 0, 0.1], 'string','Y-GTrans','FontSize',7); 
        annotation('textbox', [0.22, 0.9, 0, 0.1], 'string', 'Z-GTrans','FontSize',7); 
       
    annotation('textbox', [0.26, 0.9, 0, 0.1], 'string', 'X','FontSize',7); 
       annotation('textbox', [0.30, 0.9, 0, 0.1], 'string','Y','FontSize',7); 
        annotation('textbox', [0.34, 0.9, 0, 0.1], 'string', 'Z','FontSize',7); 
       
        
   annotation('textbox', [0.65, 0.9, 0, 0.1], 'string', 'X-LRot','FontSize',7); 
    annotation('textbox', [0.69, 0.9, 0, 0.1], 'string','Y-LRot','FontSize',7); 
     annotation('textbox', [0.73, 0.9, 0, 0.1], 'string', 'Z-LRot','FontSize',7); 
      annotation('textbox', [0.77, 0.9, 0, 0.1], 'string', 'X-LTrans','FontSize',7); 
       annotation('textbox', [0.81, 0.9, 0, 0.1], 'string','Y-LTrans','FontSize',7); 
        annotation('textbox', [0.85, 0.9, 0, 0.1], 'string', 'Z-LTrans','FontSize',7); 
        
    annotation('textbox', [0.95, 0.9, 0, 0.1], 'string', 'angles','FontSize',7); 
